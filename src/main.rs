...
fn rng(seed: &mut usize) -> usize {
    *seed = (*seed).wrapping_mul(1103515245).wrapping_add(12345);
    (*seed >> 16) & 0x7FFF
}

fn random_sort<T: Clone>(items: &Vec<T>, seed: &mut usize) -> Vec<T> {
...
fn draw_prize_item(idx_box: &mut Vec<usize>, random_sort_items: &mut Vec<String>) -> String {
...
fn calculate_draw_rate(prize_items: &Vec<(&str, i32)>) -> HashMap<String, f32> {
